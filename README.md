...
| [`:feature:profile`](feature/profile) | 마이 홈(프로필 요약·완성도 게이지와 빈 칸 안내·메뉴 4종·계정 설정), 프로필 편집(이름·학교·학과·학점·졸업 연도와 희망 직무 3개·관심 태그 5개 — 검증·목록·피커를 온보딩과 한 벌로 공유), domain use case. 하단 탭 「마이」가 이 화면이다 | 경험 카드·과거 지원서 화면 |
